...
import com.agro.client.ArticleFiegnClient;
import com.agro.client.VideoFiegnClient;
...
public class CollectServiceImpl implements CollectService {
    ...
    @Autowired
    private VideoFiegnClient courseVideoMapper;
    @Autowired
    private ArticleFiegnClient articleMapper;
...
//            CourseVideo video = courseVideoMapper.selectOneByExample(e);
            CourseVideo video = (CourseVideo) courseVideoMapper.getVideoInfo(collect.getProductionId()).getData();
