...
import com.agro.mapper.ArticleMapper;
...
//            User user = (User) userService.getUserInfo(article.getUserId()).getData();
            Object data = userService.getUserInfo(article.getUserId()).getData();
            Object o = JSONObject.toJSON(data);
            User user =  JSONObject.toJavaObject((JSON) o,User.class);
